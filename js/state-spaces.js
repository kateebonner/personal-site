...
const FIGURES = {
  ...
  su2: {
    ...
    // the turn is R_z composed with R_x, generated by Z and X; in the rests only the phase acts, generated by I
    active(t) { if (t < 4) return []; const tau = (t - 4) % 10.4; return tau < 4.4 || (tau >= 5.2 && tau < 9.6) ? ['X', 'Z', 'Rx', 'Rz'] : ['I', 'Ph']; },
    frame(t, w, h) {
      const V = stageView(w, h), S = [];
